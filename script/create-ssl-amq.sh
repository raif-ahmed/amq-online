export AMQ_URL=messaging-1.apps.cluster-40ff.40ff.sandbox1401.opentlc.com

export AMQ_TRUSTSTORE=amq-online
export AMQ_KEYSTORE=amq-online 
export AMQ_KEYSTORE_PASSWORD=passw0rd

export AMQ_CLIENT_KEYSTORE=amq-client
